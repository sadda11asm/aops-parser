...
function putText(counterOfYear, counterOfScale, counterOfName, year, section, type, idofText) {
    var ref = firebase.database().ref().child(counterOfScale + '/' + counterOfName + '/' + counterOfYear)
    request.post({
        url: 'https://artofproblemsolving.com/m/community/ajax.php',
        form: {
